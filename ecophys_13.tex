...
\begin{frame}{Why do plants need water?}
    \begin{itemize}
        ...
        medium.
        \item Turgor (\emph{nestejännitys}) or pressure is needed for cell expansion and
...
\begin{frame}{Water potential}
    \begin{itemize}
        ...
        zero. ($\Wpot^0 = 0$, the zero as superscript means standard conditions: 25~C and atmospheric pressure)
...
\begin{frame}{Water potential changes}
    \centering\includegraphics[height=0.8\textheight]{figures/Larcher4.3Hoffler.pdf}\\
...
\begin{frame}{Water path out of leaf}
   \centering\includegraphics[height=0.85\textheight]{figures/Taiz4.11LeafCrossSection.pdf}\\
    {\small \autocite[from][]{TaiZei2006}.}
\end{frame}

\begin{frame}{Stoma}
    \centering\includegraphics[height=0.85\textheight]{figures/Taiz18.8Stoma.pdf}\\
    {\small \autocite[from][]{TaiZei2006}.}
\end{frame}
...
\begin{frame}{Water path in root}
    \centering\includegraphics[height=0.85\textheight]{figures/Taiz4.4RootCrossSection.pdf}\\
    {\small \autocite[from][]{TaiZei2006}.}
\end{frame}

\begin{frame}{Water path in ectomycorrhiza}
    \centering\includegraphics[height=0.85\textheight]{figures/Mykowater_Lehto.pdf}\\
...
\begin{frame}{Water potential profiles}
    \centering\includegraphics[height=0.85\textheight]{figures/Larcher4.11WaterPotentialProfiles.pdf}\\
    {\small \autocite[from][]{Larcher2003}.}
\end{frame}

\begin{frame}{As soil dries\ldots}
    \centering\includegraphics[width=\textwidth]{figures/Larcher4.26SchematicSlatyer.pdf}\\
    {\small \autocite[from][]{Larcher2003}.}
\end{frame}
...
\begin{frame}{Water content in soils}
    \centering\includegraphics[height=0.8\textheight]{figures/Kozlowski6.1SoilWaterContent.pdf}\\
...
\begin{frame}{Water potential in soils}
    \centering\includegraphics[height=0.75\textheight]{figures/Larcher4.6SoilWaterPotential.pdf}\\
...
\begin{frame}{Driving forces}
    \centering\includegraphics[height=0.8\textheight]{figures/Taiz4.1DrivingForces.pdf}\\
